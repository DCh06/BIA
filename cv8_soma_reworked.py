...
class Solution:
    def __init__(self, dimension, lower_bound, upper_bound, popsize, numberofcycles, fncObject):
...
for i in range(30):
    ...
    solved = solution.self_organazing_migrating_algorithm(goFnc)
